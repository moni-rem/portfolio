...
const [skills, setSkills] = useState([
  ...
  const card =
    "bg-zinc-900 rounded-2xl shadow-lg p-8 border border-white/5 hover:shadow-[0_0_35px_#3b82f6] transition-all duration-300";

  return (
  <div className="relative min-h-screen text-white p-6 md:p-10 font-sans overflow-hidden">
  ...
  <div className="relative z-10">
      ...
      <div className="flex justify-center md:justify-start">
        <button
          ...
          className="bg-pink-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition font-semibold"
        >
      ...
      {/* Header */}
      <header className="mt-6 h-20 md:h-24 flex items-center justify-center rounded-xl shadow-lg hover:shadow-[0_0_30px_#3b82f6] transition">
        <nav>
        ...
        <section id="profile" className={card}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              {[
                ["Full name", "Ahn Keon Ho"],
                ["Email", "keoho@gmail.com"],
                ["Phone", "012 345 678"],
